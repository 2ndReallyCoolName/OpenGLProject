...
public:
	...
	virtual void draw(glm::mat4& transformation, glm::mat4& projection, glm::mat4& view, DirectionLight& dirLight, SpotLight& spotLight, std::vector<PointLight*>& pointLights) = 0;

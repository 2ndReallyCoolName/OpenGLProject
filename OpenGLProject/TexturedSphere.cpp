...
TexturedSphere::TexturedSphere(unsigned int m, unsigned int n, bool normal)
{
	if (normal) {
...
void TexturedSphere::draw(glm::mat4& transformation, glm::mat4& projection, glm::mat4& view, glm::vec3& lightPos)
{
	BindTextures();
	useShader();

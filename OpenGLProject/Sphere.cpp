...
Sphere::Sphere(unsigned int m, unsigned int n, bool normal)
{
	if (normal) {
...
void Sphere::draw(glm::mat4& transformation, glm::mat4& projection, glm::mat4& view, glm::vec3& lightPos)
{
	useShader();
